...
That issue with Servo demonstrates that our Panic and Signal Handling is really poor; some of the problems could be solved investigating that further. [set_hook; signal-hook];
